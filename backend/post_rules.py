...
def apply_post_rules(data: Dict[str, Any], diff: str, message: str) -> Dict[str, Any]:
    ...
    No toca la forma del JSON (eso ya lo garantiza validate_response).
    """
    ...
    # 4) Calidad del mensaje de commit
    ...
    # OJO: el label se recalculará en validate_response; aquí solo tocamos value.
